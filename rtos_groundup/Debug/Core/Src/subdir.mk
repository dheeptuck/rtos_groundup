...
C_SRCS += \
../Core/Src/main.c \
../Core/Src/premptive_scheduler.c \
...
OBJS += \
./Core/Src/main.o \
./Core/Src/premptive_scheduler.o \
...
C_DEPS += \
./Core/Src/main.d \
./Core/Src/premptive_scheduler.d \
...
Core/Src/premptive_scheduler.o: ../Core/Src/premptive_scheduler.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m0 -std=gnu11 -g3 -DUSE_HAL_DRIVER -DSTM32F030x8 -DDEBUG -c -I../Drivers/STM32F0xx_HAL_Driver/Inc -I../Drivers/CMSIS/Include -I../Core/Inc -I../Drivers/STM32F0xx_HAL_Driver/Inc/Legacy -I../Drivers/CMSIS/Device/ST/STM32F0xx/Include -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Core/Src/premptive_scheduler.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
